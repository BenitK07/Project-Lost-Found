...
const CreateFoundItem = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const myItemsResponse = await api.get('/found-items/my');
  ...
  const handleImageUpload = async (e) => {
    ...
    for (const file of files) {
      ...
      try {
        await api.post(`/images/found/${itemId}`, formData, {
    ...
    <div className="item-form-container">
      <div className="item-form-card">
        <div className="form-header">
          <FiCheckCircle className="header-icon found-icon" />
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="e.g., Cafeteria near vending machines"
              required
            />
          </div>
